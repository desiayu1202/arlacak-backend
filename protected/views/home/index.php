...
<body onload="load()">
	<h1>Selamat datang di <i><?php echo CHtml::encode(Yii::app()->name); ?> </i><img src="<?php echo Yii::app()->request->baseUrl; ?>/custom/production/images/img2.png" alt="..." style='height:50px; width:50px;'></h1>
          ...
          <div class="row tile_count">
            ...
            <?php
              ...
              foreach ($modelgetAllNamaKategori as $data) : {
                ?>
                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
             <span class="count_top"><i class="fa fa-list-alt"></i>Lap. <?php echo $data['keterangan']; ?> Hari Ini</span>
              <div class="count red">
               <!-- print data -->
                    <?php
