          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="<?php echo Yii::app()->request->baseUrl; ?>/custom/production/images/img.png" alt="..." class="img-circle profile_img">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/home"><i class="fa fa-home"></i> Halaman Utama</a>
                  </li>
                  
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/kecelakaan/admin"><i class="fa fa-truck"></i>Laporan <?php echo $judul; ?>
                </a>
                  </li>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/lokasiPenting/admin"><i class="fa fa-map-marker"></i> Pos Polisi</a>
                  </li>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/berita/admin"><i class="fa fa-pencil-square-o"></i> Berita Terbaru</a>
                  </li>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/user/admin"><i class="fa fa-android"></i> Pengguna App Android</a>
                  </li>
                  <li><a target="blank" href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/home/cetak"><i class="fa fa-newspaper-o"></i> Rekap Laporan </a>
                  </li>
                </ul>
              </div>
              <div class="menu_section">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo Yii::app()->request->baseUrl; ?>/custom/production/images/img.png" alt=""><?php echo $username ?>
                    <span class=" fa fa-angle-down"></span>
                  </a>
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/WebUser/update/<?php echo $id; ?>"> Profile</a></li>
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    ...
                    <li>
                      <a target="blank" onclick="window.open('<?php echo Yii::app()->request->baseUrl; ?>/index.php/kecelakaan/<?php echo $data['id_kecelakaan'];  ?>')">             
                        <span class="image"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/laka/<?php echo $data['foto']; ?>" alt="Profile Image" /></span>
                        <span>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/home"><i class="fa fa-home"></i> Halaman Utama</a>
                   ...
                   <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/kategori/admin"><i class="fa fa-tasks"></i>Data Master Kategori</a>
                  </li>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/kecelakaan/admin"><i class="fa fa-truck"></i>Data Master Laporan</a>
                  </li>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/lokasiPenting/admin"><i class="fa fa-map-marker"></i>Data Master Pos Polisi</a>
                  </li>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/berita/admin"><i class="fa fa-pencil-square-o"></i>Data Master Berita Terbaru</a>
                  </li>
                  <li><a><i class="fa fa-users"></i>Data Master Pengguna <span class="fa fa-chevron-down"></span> </a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/user/admin">Pengguna App Android</a></li>
                      <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/webUser/admin">Administrator Polisi</a></li>
                    </ul>
                  </li>
                  <li><a target="blank" href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/home/cetak"><i class="fa fa-newspaper-o"></i>Data Master Rekap Laporan </a>
                  </li>
                </ul>
              </div>
              <div class="menu_section">
...
<!-- page content -->
        ...
        <!-- footer content -->
        <footer>
          <div class="pull-right"><img src="<?php echo Yii::app()->request->baseUrl; ?>/custom/production/images/img2.png" alt="..." style='height:40px; width:40px;'>
            AR Lacak - Inkubator Teknik Informatika Uin Suska <a href="https://inkubator-tif.com">2017</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
