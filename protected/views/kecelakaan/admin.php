		...
		<div class="col-md-12">
			...
			<!-- <div class="panel"> -->
				<div class="">
					<div class="col-md-12">
					<h3>
						<i class="fa fa-truck"></i> Laporan <?php echo $judul ?> <small> AR - Lacak </small> 
								...
								<?php foreach ($model as $data) : ?>
									...
									<tr>
										...
										<td>
											...
											<a title="Share ke Telegram" href="https://telegram.me/share/url?url=<?php echo"--ARLacakReport-- Telah terjadi '$judul' pada '$waktu_pelaporan' di '$lokasi', harap tindak lanjuti! Lokasi : "; echo 'http://maps.google.com/maps?q='; echo $lat; echo ','; echo $lng; ?>" target="_blank"><img src='<?php echo Yii::app()->request->baseUrl; ?>/custom/production/images/telegram.png' style='height:22px; width:22px;'/> </a>
											<!--Telegram Share Button End-->

											<!--Whatsapp Share button Start-->
											<a title="Share ke WhatsApp" href='https://web.whatsapp.com://send?text= <?php echo"--ARLacakReport-- Telah terjadi $judul pada $waktu_pelaporan di $lokasi, harap tindak lanjuti! Lokasi : https://www.google.com/maps/search/$lat,$lng"; ?>' target="_blank"><img src='<?php echo Yii::app()->request->baseUrl; ?>/custom/production/images/whatsapp.png' style='height:26px; width:26px;'/> </a>
