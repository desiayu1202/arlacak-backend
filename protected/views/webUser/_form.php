...
<p class="note">Form dengan tanda <span class="required">*</span> wajib diisi.</p>
  ...
  <br>
	...
	<div class="form-group">
    	...
    	<div class="col-sm-9">
      	<?php echo $form->numberField($model,'no_identitas',array('class'=>'form-control has-feedback-left','required'=>'required', 'placeholder'=>'contoh: 83071339','size'=>20,'maxlength'=>20)); ?>
        <span class="fa fa-list-alt form-control-feedback left" aria-hidden="true"></span>
    	</div>
