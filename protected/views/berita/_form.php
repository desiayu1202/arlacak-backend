...
<p class="note">Form dengan tanda <span class="required">*</span> wajib diisi.</p>
  ...
  ?>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
    <?php echo $form->textField($model,'tanggal',array('class'=>'form-control has-feedback-left','value'=>date_format($dateConvert, 'j F Y, \p\u\k\u\l G:i'), 'placeholder'=>'tanggal post','required'=>'required','readonly'=>'readonly','size'=>50,'maxlength'=>50)); ?>
