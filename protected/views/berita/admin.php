...
<div class="row">
		<div class="col-md-12">
			...
			<!-- <div class="panel"> -->
				<div class="">
					<div class="col-md-6">
					<h3><i class="fa fa-pencil-square-o"></i> Berita Terbaru <small> AR - Lacak </small></h3>
				</div>
							...
							<tbody>
								...
								<?php foreach ($model as $data) : ?>
									...
									<tr>
										...
										<td><?= $data->judul; ?></td>
										<td><?= $data->tanggal; ?></td>
										<td><img class="img-responsive avatar-view" height="100" width="100" src="<?php echo Yii::app()->request->baseUrl; ?>/images/<?php echo $data->gambar; ?>"</td>
										<td><?= $data->isi; ?></td>
										<td>
										<!--<div class="hidden-sm hidden-xs action-buttons">-->
											<!-- <a class="btn btn-info btn-xs" href="<?= $data->id; ?>" role="button"><i class="fa fa-search"></i></a> -->
											<a class="btn btn-warning btn-xs" href="update/<?= $data->id; ?>" role="button"><i class="fa fa-pencil"></i> Edit Berita</a>
